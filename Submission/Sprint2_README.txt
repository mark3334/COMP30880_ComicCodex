...
- Read a TSV file containing English text, input it into the `translateToSpanish` function, and output a translated Spanish file.
...
- OpenAI has a rate limit per minute, and this issue needs to be addressed later.
